    ...
    <div className="container" id="container">
      <div className="form-container sign-up" id="sigNUp">
        ...
        <Image src={logoImage} width={200} height={150} alt="Logo" />
          ...
          <br/>
          <input type="text" placeholder="RegNo" value={regNumber} onChange={(e) => setRegNumber(e.target.value)} />
          ...
          >
            ...
            <option value="2">Malawi University of Business and Applied Sciences</option>
            <option value="3">Lilongwe University of Agriculture and Natural Resources</option>
          ...
          <b className="hidden"  onClick={handleSubmit}>create account</b>
          <p>Already have an account?<a className='hidden' > Login</a></p>        </form>
      </div>
