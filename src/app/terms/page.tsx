...
export default function TermsAndConditions() {
  ...
  return (
    ...
    <div>
     ...
     <br/>
        <h2 className='h2'>1. Repayment Timeline</h2>
        <p >
        ...
        <h2 className='h2'>2. Repayment Period</h2>
        <p >
        ...
        <h2 className='h2'>3. Annual Application</h2>
        <p>
          The loans shall be applied for each and every year.
        </p>
  
        <h2 className='h2'>4. Interest and Fee</h2>
        <p>
        ...
        <h2 className='h2'>7. Discontinuation of Studies</h2>
        <p>
        ...
        <h2 className='h2'>8. Repayment Schedule</h2>
      <p>
      ...
      <h2 className='h2'>9. Default in Repayment</h2>
      <p>
      ...
      <h2 className='h2'>10. Certification and Agreement</h2>
      <p>
      ...
      <h2 className='h2'>11. Loan Disbursement</h2>
      <p>
